    ...
    return (
        <div className="min-h-screen text-[#2C1A14] bg-[#FAF6F0] relative selection:bg-[#C07C4A] selection:text-[#FAF6F0] scroll-smooth">
            ...
            <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 min-h-[400px]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-left animate-in fade-in duration-300">
                    {menuItems.filter(i => i.category === activeTab).map((item) => (
                        <div key={item.id} className="bg-[#FAF6F0] rounded-2xl border border-[#2C1A14]/15 p-4 flex flex-col justify-between hover:shadow-lg transition-all duration-300 group hover:-translate-y-1">
